      ...
      'kmeans': {
        ...
        'parameters': {
          'n_clusters': {
            ...
            'max': 10,
            'default': 8,
            'description': 'controls the number of groups that the algorithm is trying to find',
            'is_highlighted': false,
            'type': 'int'
          }
        },
      ...
      'pca': {
        ...
        'parameters': {
          'n_components': {
            ...
            'max': 1,
            'default': 2,
            'description': 'The algorithm selects the number of components such that the amount of variance that needs to be explained is greater than the percentage specified by n_components',
            'is_highlighted': false,
            'type': 'float'
          }
        },
